                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                        ...
                        <td style="padding: 15px;">
                            ...
                            <?php if($is_admin): ?>
                                <a href="delete-category.php?id=<?php echo $id; ?>" style="color: #ff4757; text-decoration: none; font-weight: bold;" onclick="return confirm('Are you sure you want to delete this category?')">Delete</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php 
