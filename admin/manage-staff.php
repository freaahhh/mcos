    ...
    <div class="wrapper">
        ...
        <?php if ($is_admin): ?>
            <div style="text-align: right; margin-bottom: 20px;">
                <a href="add-staff.php" class="btn-primary" style="background: #2ecc71; padding: 10px 20px; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-flex; align-items: center; gap: 8px;">
                    <img src="../images/icons/add-user.png" alt="Add User" style="width: 20px; height: 20px;">New Staff
                </a>
            </div>
                        ...
                        <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                            ...
                            <td style="padding: 15px;">
                                <?php if ($is_admin && $id != 1): ?>
                                    <a href="update-staff.php?id=<?php echo $id; ?>" class="btn-action" title="Update & Role"><img src="../images/icons/edit.png" alt="Edit"></a>
                                    <a href="delete-staff.php?id=<?php echo $id; ?>" class="btn-action" title="Delete" onclick="return confirm('Are you sure you want to delete this staff member?')"><img src="../images/icons/delete.png" alt="Delete">
                                    <?php elseif ($id == 1): ?>
