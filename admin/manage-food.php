...
<div class="main-content" style="background-color: #f1f2f6; padding: 3% 0;">
    <div class="wrapper">
        ...
        <div style="text-align: right; margin-bottom: 20px;">
            <a href="add-food.php" class="btn-primary" style="background: #2ecc71; padding: 10px 20px; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-flex; align-items: center; gap: 8px;">
                <img src="../images/icons/add.png" alt="Add" style="width: 20px; height: 20px;">New Menu</a>
        </div>
                    ...
                    ?>
                        <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                            ...
                            <td style="padding: 15px;">
                                ...
                                <?php } else {
                                    echo "<span style='color:#747d8c;'>N/A</span>";
                                } ?>
                            </td>
                            <td style="padding: 15px;">
                                <?php if ($available == 1): ?>
                            ...
                            <td style="padding: 15px;">
                                <a href="update-food.php?id=<?php echo $id; ?>" class="btn-action" title="Update & Role"><img src="../images/icons/edit.png" alt="Edit"></a>
                                <?php if ($is_admin): ?>
                                    <a href="delete-food.php?id=<?php echo $id; ?>" class="btn-action" title="Delete" onclick="return confirm('Are you sure you want to delete this menu?')"><img src="../images/icons/delete.png" alt="Delete">
                                    <?php endif; ?>
                            </td>
                        </tr>
                    <?php
